  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
            icon: const Icon(Icons.close), //close (cross) icon
            onPressed: closeScreen, // Call the closeScreen function on press
          ),
        ),
                      ...
                      child: ElevatedButton(
                          onPressed: () async {
                            if (mobileNum.isEmpty) {
                              // Show a toast for invalid mobile number which is empty
